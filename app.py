...
# Initializing the streamlit app frontend
...
submit = st.button("Give me information about total calories")


input_prompt = """
You are an expert in nutritionist where you need to see the food items from the range 
        ...
        split of the ratio of carbohydrates, fats, fibres, sugar and things required in our diet
"""
